<header class="p-3 bg-dark text-white">
    <div class="container">
      ...
      <?php else: ?>
        <div class="text-end">
          <button onclick="document.location='form for registration/login.php'" type="button" class="btn btn-outline-light me-2">Войти</button>
          <button onclick="document.location='form for registration/register.php'" type="button" class="btn btn-warning">Регистрация</button>
        </div>
      <?php endif; ?>
      </div>
    </div>
